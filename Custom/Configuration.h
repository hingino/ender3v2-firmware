...
#define CUSTOM_MACHINE_NAME "Eino"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  13.55,  28.72 }
    #define DEFAULT_Ki_LIST {   0.88,   2.62 }
    #define DEFAULT_Kd_LIST {  52.02,  78.81 }
  #else
    // Ender 3 v2
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 13.08f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1060f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1003f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  ...
  #define MPC_TUNING_POS { X_CENTER, Y_CENTER, 0.34f } // (mm) M306 Autotuning position, ideally bed center at first layer height.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39, 0, -1.425 }
